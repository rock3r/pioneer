...
Standard commands live in the Quick reference above and `docs/TESTING.md`; `npm run check` runs the full gate (lint, typecheck, unit tests, build, e2e). The notes below are the non-obvious caveats for this VM.
