...
Pioneer requires Node.js 22.19.0 or newer, npm, and a configured Pi installation. Pi `0.80.6` is the minimum; this release is tested through Pi `0.86.0` and warns rather than blocks on newer versions. Install the CLI with:
