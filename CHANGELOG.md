...
- Certify Pi `0.87.1` as the newest tested compatibility endpoint after reviewing the [0.87.1](https://github.com/earendil-works/pi/releases/tag/v0.87.1) release (frontier model catalog additions, default xAI model, compaction-summary and image-part fixes, and fail-closed invalid `--mode`). Required CLI options and thinking levels are unchanged; the minimum stays `0.80.6`.
